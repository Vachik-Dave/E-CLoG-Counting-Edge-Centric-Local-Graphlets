...
---------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------
#	This package calculated edge-centric local graphlet counts for given undirected graph.
#	It is an implementation of algorithm published in the paper "E-CLoG: Counting Edge-Centric Local Graphlets. BigData-2017."
---------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------
			********************** Author: Vachik S. Dave. **********************
---------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------
*/
...
// change the edge_list variable
    	...
    	for(unsigned int i=0; i < num; i++)
	{
		...
		if(u >= g.N || v >= g.N)
			cout << "Node_id bigger than graph size for edge:" << u << "," << v << "\n";
			continue;
...
//*/
	...
	char hop_lbl[30] = "_graphlet_frequency_5_omp.txt";
...
//	disp_edges(1);
	...
	cout << "Edge list file starts from next line.\n";	
	//---------- To print sorted edge_list
	cout << edge_list.size() << "\n";
	for(int index = 0; index < edge_list.size() ; index++)
		cout << edge_list[index].first << " " << edge_list[index].second << "\n";
